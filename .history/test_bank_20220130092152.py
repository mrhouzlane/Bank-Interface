...
import unittest
from bank import Vault
from Exception import MyExcept, SecondEx
...
class LearnTest(unittest.TestCase):
    ...
    def test_get_email(self):
        ...
        c = 200
        e = result.creerCompte(a, b, c)
        self.assertEqual("Mehdi@BANK-RHOUZLANE.com", result.getEmail())
    ...
    def test_throw_error(self):
        ...
        with self.assertRaises(MyExcept, msg=" Reessayez !! ") as context:
            result.retrait(500)
